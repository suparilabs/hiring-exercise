...
export type { Bard } from "./Bard";
export type { BardFactory } from "./BardFactory";
...
export { Bard__factory } from "./factories/Bard__factory";
export { BardFactory__factory } from "./factories/BardFactory__factory";
